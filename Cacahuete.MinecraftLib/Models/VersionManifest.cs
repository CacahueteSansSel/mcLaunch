...
public class VersionManifest
{
    ...
    public ManifestMinecraftVersion LatestRelease => Versions.First(ver => ver.Id == Latest.Release);
    public ManifestMinecraftVersion LatestSnapshot => Versions.First(ver => ver.Id == Latest.Snapshot);

    public ManifestMinecraftVersion[] Releases => Versions.Where(ver => ver.Type == "release").ToArray();
    public ManifestMinecraftVersion[] Snapshots => Versions.Where(ver => ver.Type == "snapshot").ToArray();
